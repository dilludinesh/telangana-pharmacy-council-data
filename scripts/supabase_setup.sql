...
CREATE INDEX IF NOT EXISTS idx_registration ON rx(registration_number);
CREATE INDEX IF NOT EXISTS idx_name ON rx(name);
CREATE INDEX IF NOT EXISTS idx_father ON rx(father_name);
